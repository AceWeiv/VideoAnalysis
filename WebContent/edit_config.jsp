	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">编辑摄像头</h1>
				
				<% Config con = (Config)request.getAttribute("con"); %>
				
				<form action="EditCam" method="post">
					<input type="text" name="id" value=<%=con.getId() %> style="display: none">
					摄像头描述:<input type="text" name="name" value=<%=con.getName() %>>
					摄像头地址:<input type="text" name="adress" value=<%=con.getAdress() %>>
					<br>
					<br>
